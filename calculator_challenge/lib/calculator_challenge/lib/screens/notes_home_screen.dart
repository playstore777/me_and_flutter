...
*/
Future<List<Map<String, dynamic>>> readDatabase(databaseName) async {
  try {
    print('databaseName from NotesHomeScreen: $databaseName');
    NotesDatabase notesDb = NotesDatabase(databaseName);
...
class NotesHomeScreen extends StatefulWidget {
  final providerData;
  NotesHomeScreen(this.providerData);
  @override
  _NotesHomeScreen createState() => _NotesHomeScreen();
}

class _NotesHomeScreen extends State<NotesHomeScreen> {
  var _providerData;
  ...
  void handleDelete() async {
    try {
      NotesDatabase notesDb =
          NotesDatabase(_providerData.getSecretText() ?? 'dummy');
      await notesDb.initDatabase();
  ...
  Widget build(BuildContext context) {
    print('Provider data from NoteHS: ${widget.providerData}');
    _providerData = Provider.of<Calculator>(widget.providerData, listen: false);
    return Scaffold(
      ...
      body: FutureBuilder(
          future: readDatabase(_providerData.getSecretText() ?? 'dummy'),
